...
typedef CGAL::Image_3 Image_3;
typedef CGAL::Gray_image_mesh_domain_3<Image_3, K, float> Image_3_Mesh_domain;
...
// Triangulation
//typedef CGAL::Mesh_triangulation_3<Image_3_Mesh_domain>::type Tr;
...
typedef Enriched_polyhedron<Kernel, Enriched_items> Mesh_2;
typedef Mesh_2::HalfedgeDS HalfedgeDS;
typedef Mesh_2::Vertex_iterator Vertex_iterator;
typedef Mesh_2::Facet_iterator Facet_iterator;
...
public:
	...
	Mesh_3_Vector_3 FacetNormal(Mesh_3_Facet_iterator fi);
	...
	// major functions
	void processRawData();
	void setCriteria(double fa, double fs, double fd, double cr, double cs);
	void buildTetMesh();
	void preprocessing();
...
private: // helpers
	double innerProductInCellHS2F(Mesh_3_Cell_iterator ci, Mesh_3_Facet_iterator f1, Mesh_3_Facet_iterator f2,
		std::map<int, Mesh_3_Vector_3> grad);
	double helperHS2F(std::map<int, Mesh_3_Vector_3> grad, std::vector<int> idxs);
...
private:
	...
	// facet normal
	std::map<Mesh_3_Facet_iterator, Mesh_3_Vector_3, Mesh_3_Facet_Iterator_Comparator> facetNormal;
	...
	// complex hodge star
	EigenSpMat m_CHS0F_B;
	EigenSpMat m_CHS1F_B;
	EigenSpMat m_CHS2F_B;
	EigenSpMat m_CHS3F;
	EigenSpMat m_CHS0F_NB;
	EigenSpMat m_CHS1F_NB;
	EigenSpMat m_CHS2F_NB;
