...
public:
	...
	void init(double d, double l, int s);
...
private:
	...
	Mesh_3_Cell_iterator _selectHighestDensityCell();
	//int _pickInvalidLine(Mesh_3_Cell_iterator ci);
	void _decreaseDensity(int idx);
